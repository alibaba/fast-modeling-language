...
over
 ...
 windowFrame
     : frameType=KW_RANGE startframe=frameBound
     | frameType=KW_ROWS startframe=frameBound
     | frameType=KW_GROUPS startframe=frameBound
     | frameType=KW_RANGE KW_BETWEEN startframe=frameBound KW_AND endframe=frameBound
     | frameType=KW_ROWS KW_BETWEEN startframe=frameBound KW_AND endframe=frameBound
     | frameType=KW_GROUPS KW_BETWEEN startframe=frameBound KW_AND endframe=frameBound
     ;
frameBound
...
refEntityStatement
: KW_REF leftTable=tableNameList leftTableComment=string? refRelationType rightTableComent=string? rightTable=tableNameList (COLON name=identifier)?
;
