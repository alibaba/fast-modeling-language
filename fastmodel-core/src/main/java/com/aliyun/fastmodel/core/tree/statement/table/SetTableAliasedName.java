...
public class SetTableAliasedName extends BaseSetAliasedName {

    public SetTableAliasedName(QualifiedName qualifiedName,
    ...
    public <R, C> R accept(AstVisitor<R, C> visitor, C context) {
        return visitor.visitSetTableAliasedName(this, context);
    }
}
