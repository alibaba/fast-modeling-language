...
public class DropChecker extends BaseOperatorStatement {

    private final Identifier checkerName;

    public DropChecker(QualifiedName qualifiedName, Identifier checkerName) {
        super(qualifiedName);
    ...
    public <R, C> R accept(AstVisitor<R, C> visitor, C context) {
        return visitor.visitDropChecker(this, context);
    }
