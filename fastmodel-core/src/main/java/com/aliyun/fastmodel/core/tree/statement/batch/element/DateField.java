 ...
 */
@Getter
public class DateField extends AbstractBatchElement {

    private final TableOrColumn tableOrColumn;

    private final String pattern;

    public DateField(TableOrColumn tableOrColumn, String pattern) {
    ...
    public <R, C> R accept(AstVisitor<R, C> visitor, C context) {
        return visitor.visitDateField(this, context);
    }
}
