 ...
 * @date 2021/6/13
 */
public class SetMaterializeAlias extends BaseSetAliasedName {

    public SetMaterializeAlias(QualifiedName qualifiedName,
    ...
    public <R, C> R accept(AstVisitor<R, C> visitor, C context) {
        return visitor.visitSetMaterializeAlias(this, context);
    }
}
