 ...
 */
@Getter
public class AddRules extends BaseOperatorStatement {
    ...
    public AddRules(QualifiedName qualifiedName, List<RuleDefinition> ruleDefinitions) {
        super(qualifiedName);
    ...
    public AddRules(QualifiedName tableName,
                    List<PartitionSpec> partitionSpecList, List<RuleDefinition> ruleDefinitions) {
        super(null);
    ...
    public <R, C> R accept(AstVisitor<R, C> visitor, C context) {
        return visitor.visitAddRules(this, context);
    }
}
