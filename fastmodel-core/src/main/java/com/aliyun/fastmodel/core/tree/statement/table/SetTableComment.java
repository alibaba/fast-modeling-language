 ...
 * DSL举例
 * <pre>
 *         ALTER TABLE ut.t1 SET COMMENT 'comment';
 *     </pre>
 *
 * @author panguanjing
 * @date 2020/9/27
...
public class SetTableComment extends BaseSetComment {

    public SetTableComment(QualifiedName qualifiedName, Comment newComment) {
