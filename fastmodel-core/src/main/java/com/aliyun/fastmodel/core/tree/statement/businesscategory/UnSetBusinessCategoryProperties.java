...
public class UnSetBusinessCategoryProperties extends BaseUnSetProperties {

    public UnSetBusinessCategoryProperties(QualifiedName qualifiedName, List<String> propertyList) {
