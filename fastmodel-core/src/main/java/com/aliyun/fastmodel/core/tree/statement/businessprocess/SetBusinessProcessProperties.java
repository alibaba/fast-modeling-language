...
public class SetBusinessProcessProperties extends BaseSetProperties {

    public SetBusinessProcessProperties(QualifiedName qualifiedName, List<Property> propertyList) {
    ...
    public <R, C> R accept(AstVisitor<R, C> visitor, C context) {
        return visitor.visitSetBpProperties(this, context);
    }
}
