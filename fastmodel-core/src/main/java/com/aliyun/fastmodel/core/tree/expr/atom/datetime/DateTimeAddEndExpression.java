 ...
 * @date 2021/4/13
 */
public class DateTimeAddEndExpression extends DateTimeAddExpression {
    public DateTimeAddEndExpression(NodeLocation location, String origin,
    ...
    public <R, C> R accept(AstVisitor<R, C> visitor, C context) {
        return visitor.visitDateTimeAddEndExpression(this, context);
    }
}
