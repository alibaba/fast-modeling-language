...
public class HologresFormatterTest {
    ...
    public void testAliasedName() {
        ...
        DialectNode dialectNode = HologresFormatter.format(createDimTable, HologresTransformContext.builder().build());
    ...
    public void testRenameTable() {
        ...
        DialectNode format = HologresFormatter.format(renameTable, HologresTransformContext.builder().build());
    ...
    public void testAddColumn() {
        ...
        DialectNode format = HologresFormatter.format(addCols, HologresTransformContext.builder().build());
        assertEquals("BEGIN;\n"
    ...
    public void testDropTable() {
        ...
        DialectNode format = HologresFormatter.format(dropTable, HologresTransformContext.builder().build());
