 ...
 * @date 2023/6/23
 */
@BuilderAnnotation(dialect = DialectName.Constants.HOLOGRES, version = Constants.V2, values = {Query.class})
@AutoService(StatementBuilder.class)
public class QueryV2Builder implements StatementBuilder<HologresTransformContext> {
    ...
    public DialectNode build(BaseStatement source, HologresTransformContext context) {
        ...
        return HologresFormatter.format((BaseStatement)node, context, HologresVersion.V2);
    }
}
