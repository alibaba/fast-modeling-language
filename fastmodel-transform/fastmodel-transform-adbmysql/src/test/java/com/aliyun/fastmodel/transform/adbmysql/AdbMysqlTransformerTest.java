...
public class AdbMysqlTransformerTest {
    ...
    public void testTransformAnn() {
        ...
        assertEquals("CREATE TABLE vector\n"
            ...
            + "   float_feature ARRAY<FLOAT>(4) NULL,\n"
            + "   short_feature ARRAY<SMALLINT>(4) NULL,\n"
    ...
    public void testFullText() {
        ...
        assertEquals("CREATE TABLE tbl_fulltext_demo\n"
            ...
            + "   content_alinlp   VARCHAR NULL,\n"
            + "   content_ik       VARCHAR NULL,\n"
            + "   content_standard VARCHAR NULL,\n"
            + "   content_ngram    VARCHAR NULL,\n"
            + "   PRIMARY KEY(id),\n"
    ...
    public void testFullType() {
        String ss = IOUtils.resourceToString("/adbmysql/issue_full_type.txt", Charset.defaultCharset());
        String result = generator(new DialectNode(ss), adbMysqlTransformer);
        assertEquals("CREATE TABLE table02\n"
            + "(\n"
            + "   `__adb_auto_id__` BIGINT NOT NULL,\n"
            + "   c1                BOOLEAN NULL COMMENT 'id',\n"
            + "   c2                TINYINT NULL COMMENT '',\n"
            + "   c3                SMALLINT NULL COMMENT '',\n"
            + "   c4                INT NULL COMMENT '',\n"
            + "   c5                INT NULL COMMENT '',\n"
            + "   c6                BIGINT NULL COMMENT '',\n"
            + "   c7                FLOAT NULL COMMENT '',\n"
            + "   c8                DOUBLE NULL COMMENT '',\n"
            + "   c9                DECIMAL(10,2) NULL COMMENT '',\n"
            + "   c10               DECIMAL(10,0) NULL COMMENT '',\n"
            + "   c11               VARCHAR(10) NULL COMMENT '',\n"
            + "   c12               BINARY NULL COMMENT '',\n"
            + "   c13               DATE NULL COMMENT '',\n"
            + "   c14               time NULL COMMENT '',\n"
            + "   c15               DATETIME NULL COMMENT '',\n"
            + "   c16               TIMESTAMP NULL COMMENT '',\n"
            + "   c17               POINT DELIMITER_TOKENIZER ' ' NULL COMMENT '',\n"
            + "   c18               ARRAY<STRING> NULL COMMENT '',\n"
            + "   c19               MAP<STRING,STRING> NULL COMMENT '',\n"
            + "   c20               JSON NULL COMMENT '',\n"
