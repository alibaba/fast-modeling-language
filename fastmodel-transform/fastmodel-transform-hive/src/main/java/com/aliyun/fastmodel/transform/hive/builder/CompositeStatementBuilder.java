...
public class CompositeStatementBuilder extends BaseCompositeStatementBuilder<HiveTransformContext> {
    ...
    @Override
    public DialectNode innerBuild(CompositeStatement compositeStatement, HiveTransformContext context) {
        return HiveFormatter.format(compositeStatement, context);
    }
}
