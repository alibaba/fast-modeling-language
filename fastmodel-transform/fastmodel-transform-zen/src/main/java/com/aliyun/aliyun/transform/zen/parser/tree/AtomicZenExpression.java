...
/**
 * BaseAtomicExpression
 *
 * @author panguanjing
 * @date 2021/7/14
 */
@Getter
public class AtomicZenExpression extends BaseAtomicZenExpression {
    /**
     * identifier
     */
    ...
    public AtomicZenExpression(Identifier identifier, Long numberValue) {
    ...
    public <R, C> R accept(BaseZenAstVisitor<R, C> visitor, C context) {
        return visitor.visitAtomicZenExpression(this, context);
    }
}
