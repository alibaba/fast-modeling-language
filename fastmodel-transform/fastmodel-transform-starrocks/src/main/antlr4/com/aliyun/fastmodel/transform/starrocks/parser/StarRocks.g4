...
multiRangePartition
    : START '(' start=string ')' END '(' end=string ')' EVERY '(' interval ')'
    | START '(' start=string ')' END '(' end=string ')' EVERY '(' INTEGER_VALUE ')'
    ;
...
baseType
    : name=BOOLEAN
    | name=TINYINT typeParameter?
    | name=SMALLINT typeParameter?
    | name=SIGNED INT?
    | name=SIGNED INTEGER?
    | name=UNSIGNED INT?
    | name=UNSIGNED INTEGER?
    | name=INT typeParameter?
    | name=INTEGER typeParameter?
    | name=BIGINT typeParameter?
    | name=LARGEINT typeParameter?
    | name=FLOAT
    | name=DOUBLE
    | name=DATE
    | name=DATETIME
    ...
    | name=PERCENTILE
    | name=JSON
    | name=VARBINARY typeParameter?
    | name=BINARY typeParameter?
    ;
