 ...
 * @date 2023/9/14
 */
public enum StarRocksPropertyKey implements PropertyKey {
    ...
    StarRocksPropertyKey(String value) {
        this(value, false);
    }

    StarRocksPropertyKey(String value, boolean supportPrint) {
        this.value = value;
        this.supportPrint = supportPrint;
    }

    public static PropertyKey getByValue(String value) {
        StarRocksPropertyKey[] starRocksProperties = StarRocksPropertyKey.values();
        for (StarRocksPropertyKey starRocksProperty : starRocksProperties) {
