 ...
 */
@Data
public class PostgreSQLArrayDataTypeName implements ISimpleDataTypeName {
    ...
    public PostgreSQLArrayDataTypeName(IDataTypeName source) {
        this.source = source;
    }
     ...
     */
    public static PostgreSQLArrayDataTypeName getByValue(String value) {
        ...
        return new PostgreSQLArrayDataTypeName(PostgreSQLDataTypeName.getByValue(source));
    }
