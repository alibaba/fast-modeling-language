 ...
 */
@Getter
public class OrderByNonKeyConstraint extends NonKeyConstraint {

    public static final String TYPE = "OrderBy";

    private final List<Identifier> columns;

    public OrderByNonKeyConstraint(Identifier constraintName, Boolean enable, List<Identifier> columns) {
        super(constraintName, enable, TYPE);
        this.columns = columns;
    }

    public OrderByNonKeyConstraint(Identifier constraintName, List<Identifier> columns) {
